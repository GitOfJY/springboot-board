...
public class CommentPath {
    ...
    public static CommentPath create(String path) {
        if (isDepthOverFlow(path)) {
            throw new IllegalStateException("Depth over flow");
        }
    ...
    public CommentPath createChildCommentPath(String descendantsTopPath) {
        ...
        String childrenToPatth = findChildresnTopPath(descendantsTopPath);
        return CommentPath.create(increase(childrenToPatth));
    }

    private String findChildresnTopPath(String descendantsTopPath) {
