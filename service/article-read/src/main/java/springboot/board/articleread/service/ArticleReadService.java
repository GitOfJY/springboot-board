package springboot.board.articleread.service;

import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import org.springframework.stereotype.Service;
import springboot.board.articleread.client.ArticleClient;
import springboot.board.articleread.client.CommentClient;
import springboot.board.articleread.client.LikeClient;
import springboot.board.articleread.client.ViewClient;
...
import springboot.board.articleread.service.event.handler.EventHandler;
import springboot.board.articleread.service.response.ArticleReadPageResponse;
import springboot.board.articleread.service.response.ArticleReadResponse;
